...
\subsection{Hybrid HPC and Cloud Environment}

%\jchen{explain how our \texttt{BEE} can let user to run on both HPC and Cloud with migration and scheduling}
%\qguan{Please consider using some kind of psudo algorithm to explain the workflow here.}
